...
export const PORTFOLIO_DATA = {
  ...
  projects: [
    ...
    },
    {
      id: "resolve-flow-ai",
      number: "09",
      title: "ResolveFlow AI — Intelligent Complaint Resolution",
      subtitle: "Orchestrated Multi-Agent Resolution System with RAG & Human-in-the-Loop Oversight",
      category: "Multi-Agent AI & Enterprise MERN",
      technologies: [
        "React / Vite",
        "Node.js",
        "Express.js",
      ...
      description:
        "Enterprise-grade complaint resolution and claim arbitration platform governed by a backend-controlled multi-agent state machine. Seamlessly connects verified customer grievances with automated AI triage, MongoDB Vector RAG store policy retrieval, automated resolution synthesis, and strict human-in-the-loop validation.",
      highlights: [
        "1. Verified Claim Ingestion: Customers file claims with mandatory database-level order ownership validation against authenticated JWT sessions to prevent IDOR vulnerabilities.",
        "2. Triage & Entity Extraction Agent: Integrates Google Gemini with Zod schema validation to classify urgency, customer sentiment, and extract structured problem entities.",
        "3. Knowledge RAG Agent: Conducts semantic vector search over MongoDB Atlas Vector Search across enterprise refund, return, and warranty policy chunks.",
        "4. Resolution Synthesis: Formulates mathematically bounded settlement proposals (partial/full refunds, replacement item dispatch, return labels).",
        "5. Human-in-the-Loop Execution: Support staff can inspect, approve, or adjust recommendations with atomic action execution and audit trails.",
      ],
      githubUrl: "https://github.com/EliyasXCode/Resolve-Flow-AI",
      liveDemoUrl: "https://resolve-flow-ai-client.vercel.app/",
      accentColor: "#2563eb",
      date: "2026",
    },
    {
