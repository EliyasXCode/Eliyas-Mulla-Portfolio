...
export const PORTFOLIO_DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      technologies: ["Python", "Django", "SQL", "JWT Authentication", "REST APIs", "Tailwind CSS"],
      description:
        "Full-stack restaurant reservation and management platform preventing double-booking and providing a centralized owner control portal.",
      highlights: [
        "Developed a Django-based restaurant booking platform with secure JWT-authenticated login for customers.",
        "Enabled real-time table reservations, reducing manual booking coordination and eliminating double-booking conflicts.",
        "Built an owner dashboard to manage bookings, update menus, and monitor customer feedback from a single interface.",
        "Optimized SQL query joins and indexed reservation timestamps for sub-50ms query response times.",
      ],
      githubUrl: "https://github.com/EliyasXCode",
      liveDemoUrl: "https://github.com/EliyasXCode",
      accentColor: "#a855f7",
